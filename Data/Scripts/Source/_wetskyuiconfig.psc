...
Bool Property PurchColdCloakSet Auto
Bool Property PurchColdHoodSet Auto
Bool Property PurchColdGloveSet Auto
Bool Property PurchColdFaceCoverSet Auto
Bool Property PurchRainHoodSet Auto
Bool Property PurchRainCloakSet Auto
Bool Property PurchSurvivalBPSet Auto
Bool Property PurchAshFaceCoverSet Auto
Bool Property PurchAshGoggleSet Auto
Bool StrongWinds
Bool DripPlayer
Bool DripActor
Bool FootWetPlayer
...
Function ApplySettings()
	...
	If PurchaseColdCloak == 1 && !PurchColdCloakSet
		...
		PurchColdCloakSet = True
	EndIf
	If PurchaseColdHood == 1 && !PurchColdHoodSet
		...
		PurchColdHoodSet = True
	EndIf
	If PurchaseColdGlove == 1 && !PurchColdGloveSet
		...
		PurchColdGloveSet = True
	EndIf
	If PurchaseColdFaceCover == 1 && !PurchColdFaceCoverSet
		...
		PurchColdFaceCoverSet = True
	EndIf
	If PurchaseRainHood == 1 && !PurchRainHoodSet
		...
		PurchRainHoodSet = True
	EndIf
	If PurchaseRainCloak == 1 && !PurchRainCloakSet
		...
		PurchRainCloakSet = True
	EndIf
	If PurchaseSurvivalBP == 1 && !PurchSurvivalBPSet
...
Event OnConfigInit()
	...
	Else
		PurchaseColdHood = 0
	EndIf
	If PurchColdGloveSet
		PurchaseColdGlove = 1
	Else
		PurchaseColdGlove = 0
	EndIf
	If PurchColdFaceCoverSet
	...
	Else
		PurchaseRainHood = 0
	EndIf
	If PurchRainCloakSet
		PurchaseRainCloak = 1
	Else
		PurchaseRainCloak = 0
	EndIf
	If PurchSurvivalBPSet
		PurchaseSurvivalBP = 1
	Else
		PurchaseSurvivalBP = 0
	EndIf
	If PurchAshFaceCoverSet
		PurchaseAshFaceCover = 1
	Else
		PurchaseAshFaceCover = 0
	EndIf
	If PurchAshGoggleSet
		PurchaseAshGoggle = 1
	Else
		PurchaseAshGoggle = 0
	EndIf
...
Function CheckGearSelection()
	If !WetHoods && !WetCloaks
		RainGearNPC = 0
	EndIf
	If !ColdHoods && !ColdCloaks && !ColdGloves && !ColdCovers
		ColdGearNPC = 0
	EndIf
...
Function CheckGearSelectionMenu()
	If !WetHoods && !WetCloaks && RainGearNPC > 0
		...
		WetCloaks = True
	EndIf
	If !ColdHoods && !ColdCloaks && !ColdGloves && !ColdCovers && ColdGearNPC > 0
		ColdHoods = True
		ColdCloaks = True
		ColdGloves = True
		ColdCovers = True
