...
Function CheckExterior()
	...
	ElseIf _WetQuest.ColdBSHeartland && HasForm(_WetQuest.ColdBSHeartland, CurrentWorld)
		If (_WetQuest.PlayerRef as ObjectReference).IsInLocation(_WetQuest.CountyBruma)
			SetColdGlobals(1, 0, true)	
		EndIf
...
Function GoHome()
	...
	If !_WetQuest.IgnoreWorkersOn
		...
		_WetSMEvent.SendStoryEventAndWait(aiValue2 = 3)
	Else
		;_WetQuest._WetGoHomeRainQuest.Start()
		_WetSMEvent.SendStoryEventAndWait(aiValue2 = 2)		 
	EndIf
	;_WetQuest._WetGoHomeBlizzQuest.Start()
	_WetSMEvent.SendStoryEventAndWait(aiValue2 = 1)
EndFunction
