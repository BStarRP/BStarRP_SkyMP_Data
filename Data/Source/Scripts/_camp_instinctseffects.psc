...
GlobalVariable MYANIMATION = None

Event OnEffectStart(Actor Target, Actor Caster)
	TargetActor = Target
	CasterActor = Caster

MYANIMATION = Game.GetFormFromFile(0x0A00AA13, "ImmersiveInteractions.esp") as GlobalVariable

Utility.Wait(0.1)
MYANIMATION.SetValue(7)
Debug.SendanimationEvent(PlayerRef, "idlegreybeardwordteach")
Utility.Wait(1.5)
MYANIMATION.SetValue(0)
